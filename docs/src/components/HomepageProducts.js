...
/*
  {
    ...
    description: (
      <>
        Get started by creating a Jupyter platform in the cloud with Langchain MCP Client. You will get Jupyter on Kubernetes with a cloud database and storage bucket to persist your notebooks and datasets.
      </>
    ),
  },
  {
