...
module.exports = {
  title: '🦜 🔗 Langchain MCP Client documentation',
  ...
  projectName: 'langchain-mcp-client', // Usually your repo name.
  markdown: {
    mermaid: true,
  },
  plugins: [
  ...
  themeConfig: {
    ...
    navbar: {
      title: 'Langchain MCP Client Docs',
      logo: {
        alt: 'Datalayer Logo',
      ...
      items: [
        ...
        {
          href: 'https://github.com/datalayer/langchain-mcp-client',
          position: 'right',
    ...
    [
      '@docusaurus/preset-classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/datalayer/langchain-mcp-client/edit/main/',
        },
        theme: {
