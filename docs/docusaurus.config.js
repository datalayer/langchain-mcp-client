...
module.exports = {
  title: '🪐 ✨ Jupyter MCP Client documentation',
  ...
  projectName: 'jupyter-mcp-client', // Usually your repo name.
  markdown: {
    mermaid: true,
  },
  plugins: [
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/datalayer/jupyter-mcp-client',
          position: 'right',
    ...
    [
      '@docusaurus/preset-classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/datalayer/jupyter-mcp-client/edit/main/',
        },
        theme: {
